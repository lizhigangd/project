...
function bindMenuClickEvent(a, b) {
    var c = a.closest(".topjui-toolbar"),
        d = {};
    c.length > 0 && (d = getOptionsJson(c)),
        b = $.extend(!0, d, b);
    var e = {};
    return "openDialog" == b.event ? (e = {},
        b.dialog.width = b.dialog.width ? b.dialog.width: 700, b.dialog.height = b.dialog.height ? b.dialog.height: 450, b = $.extend({},
        b, e)) : "openTab" == b.event ? (e = {
        iconCls: "fa fa-th"
    },
...
function searchHandler(a) {
    ...
    e += '<div id="advanceSearchDialog-buttons" style="display:none">',
        e += '<a href="#" id="resetAdvanceSearchForm" data-toggle="topjui-linkbutton" data-options="iconCls:\'icon-reload\',btnCls:\'topjui-btn\'">清空</a>',
        e += '<a href="#" id="submitAdvanceSearchForm" data-toggle="topjui-linkbutton" data-options="iconCls:\'icon-search\'">查询</a>',
        e += '<a href="#" id="closeAdvanceSearchDialog" data-toggle="topjui-linkbutton" data-options="btnCls:\'topjui-btn-danger\'">关闭</a>',
        e += "</div>",
        $("body").append(e);
    var f = $("#" + b.dialog.id);
    f.dialog(b.dialog),
...
function importHandler(a) {
    ...
    if ("object" == typeof b.grid) {
        ...
        e += '<div id="importDialog-buttons" style="display:none">',
            ...
            e += '<a href="#" id="closeImportDialog" data-toggle="topjui-linkbutton" data-options="btnCls:\'topjui-btn-danger\'">关闭</a>',
            e += "</div>",
            $("body").append(e);
        var f = $("#" + b.dialog.id);
        f.dialog(b.dialog);
        ...
        $.ajax({
            ...
            success: function(c, d, e) {
                $.messager.progress("close"),
                    ...
                    1 == c.statusCode || 100 == c.statusCode || 200 == c.statusCode ? (b.statusCode = 200, b.title = c.title, b.message = c.message) : 1 == c ? (b.statusCode = 200, b.title = "操作提示", b.message = "操作成功！") : (b.statusCode = 300, b.title = c.title, b.message = c.message)
            }
        }),
        b
}
...
function getMultiRowsFieldValue(a, b) {
    ...
    function(a) {
        ...
        function e(d) {
            ...
            return g.find("a:first").focus().addClass("topjui-btn-danger").find(".l-btn-left").addClass("l-btn-icon-left").append('<span class="l-btn-icon fa fa-check-circle">&nbsp;</span>'),
                g.find("a:eq(1)").addClass("topjui-btn-normal").find(".l-btn-left").addClass("l-btn-icon-left").append('<span class="l-btn-icon fa fa-check-circle">&nbsp;</span>'),
                e
        }
        function f(a, b) {
...
var _hmt = _hmt || []; !
    function() {
        ...
        a.src = "https://hm.baidu.com/hm.js?71559c3bdac3e45bebab67a5a841c70e";
...
var openDialog = function(a) {
        ...
        if ("object" == typeof d) openDialogAndloadDataByParentGrid(b);
            ...
            var e = $("#" + c.id);
            if (e.iDialog(b.dialog), b.dialog.href.indexOf("{") != -1) {
                var f = getSelectedRowData(b.grid.type, b.grid.id),
                    g = replaceUrlParamValueByBrace(appendSourceUrlParam(c.href), f);
                e.iDialog({
                    href: g
                }),
                    e.iDialog("open")
...
topJUI = $.extend(!0, defaultConfig, topJUI),
    function(a) {
        function b(b, c) {
            b.preventDefault();
            var d = a(this),
        ...
        a.fn.iDatagrid = function(b, c) {
            ...
            a.fn.iDatagrid.methods = {
                ...
                singleSelectedAjax: function(b, c) {
                    ...
                    return null == d ? void a.messager.alert(topJUI.language.message.title.operationTips, topJUI.language.message.msg.selectSelfGrid, topJUI.language.message.icon.warning) : (c.url = replaceUrlParamValueByBrace(c.url, d), void a.messager.confirm(topJUI.language.message.title.confirmTips, c.confirmMsg,
                        function(a) {
                            if (a) {
                                var b = doAjax(c);
                                200 == b.statusCode && refreshGrid(c.grid.type, c.grid.id),
                                    showMessage(b)
                            }
                        }))
                },
                multiSelectedAjax: function(b, c) {
                    ...
                    return 0 == d.length ? void a.messager.alert(topJUI.language.message.title.operationTips, topJUI.language.message.msg.selectSelfGrid, topJUI.language.message.icon.warning) : void a.messager.confirm(topJUI.language.message.title.confirmTips, c.confirmMsg,
                        function(a) {
                            if (a) {
                                var b;
                ...
                multiCheckedAjax: function(b, c) {
                    var d = getCheckedRowsData(c.grid.type, c.grid.id);
                    return 0 == d.length ? void a.messager.alert(topJUI.language.message.title.operationTips, c.grid.uncheckedMsg, topJUI.language.message.icon.warning) : void a.messager.confirm(topJUI.language.message.title.confirmTips, c.confirmMsg,
                        function(a) {
                            if (a) {
            ...
            a.fn.iDatagrid.parseOptions = function(b, c) {
                var d = a.extend({},
                    a.fn.datagrid.parseOptions(b), a.fn.iDatagrid.defaults, a.parser.parseOptions(b, ["id"]), c);
                return setId(b, d)
            },
            a.fn.iDatagrid.defaults = {
                ...
                onLoadSuccess: function() {
                    ...
                    if (a(this).iDatagrid("doCellTip", {
                            cls: {},
                            delay: 500
                        }), "object" == typeof b.childGrid) for (var c = b.childGrid.grids,
                                                                     d = 0; d < c.length; d++) {
                ...
                onClickRow: function(b, c) {
                    ...
                    if ("object" == typeof d.childTabs) for (var h = d.childTabs,
                                                                 g = 0; g < h.length; g++) {
                        var i = a("#" + h[g].id),
                            j = i.tabs("options"),
            ...
            a.fn.iDialog.defaults = {
                ...
                onLoad: function() {
                    ...
                    if (b.mbId) {
                        ...
                        if (a.messager.progress("close"), a(this).trigger(topJUI.eventType.initUI.form), a(this).dialog("center"), void 0 != b.url) {
    ...
    function(a) {
        ...
        a.fn.datagrid.defaults.onHeaderContextMenu = b,
            ...
            a.fn.iEdatagrid.parseOptions = function(b, c) {
                var d = a.extend({},
                    a.fn.edatagrid.parseOptions(b), a.fn.iEdatagrid.defaults, a.parser.parseOptions(b, ["id"]), c);
                return setId(b, d)
            },
    ...
    function(a) {
        a.fn.iLinkbutton = function(b, c) {
            ...
            a.fn.iLinkbutton.parseOptions = function(b, c) {
                var d = a.extend({},
                    a.fn.linkbutton.parseOptions(b), a.fn.iLinkbutton.defaults, a.parser.parseOptions(b, ["id"]), c);
                return setId(b, d)
            },
                    ...
                    if ("ajaxForm" == b.handler || "multiAjaxForm" == b.handler) {
                        ...
                        if (a("#" + b.dialogId).form("validate")) {
                            if (b.ajaxData = a("#" + b.dialogId).serialize(), void 0 != b.combotreeFields) {
                                var f = "";
                                a.each(options.combotreeFields,
                                    function(c, d) {
                                        f += "&" + d.replace(b.postfix, "") + "=" + a("#" + b.dialogId + ' input[textboxname="' + d + '"]').combotree("getValues").join(",") + ", "
                                    }),
                                    b.ajaxData += f
                            }
                            if ("multiAjaxForm" == b.handler) {
                                var g = getCheckedRowsData(e.type, e.id);
                                if (0 == g.length) return void a.messager.alert(topJUI.language.message.title.operationTips, topJUI.language.message.msg.checkSelfGrid, topJUI.language.message.icon.warning);
                                var h = void 0 == e.pkName ? topJUI.config.pkName: e.pkName;
                                b.ajaxData += "&" + h + "s=" + getMultiRowsFieldValue(g, h)
                            }
                            var i = doAjax(b);
                            if (200 == i.statusCode) {
    ...
    +
        function(a) {
            "use strict";
            a(document).on(topJUI.eventType.initUI.form,
                function(b) {
                    a('[data-toggle="topjui-switchbutton"]').each(function(b) {
                        var c = a(this),
                            d = getOptionsJson(c);
                        c.iSwitchbutton(d)
                    }),
                        a('[data-toggle="topjui-form"]').each(function(b) {
                            var c = a(this),
                                d = getOptionsJson(c);
                            c.iForm(d)
                        }),
                        a('[data-toggle="topjui-validatebox"]').each(function(b) {
                            var c = a(this),
                                d = getOptionsJson(c);
                            c.iValidatebox(d)
                        }),
                        a('[data-toggle="topjui-textbox"]').each(function(b) {
                            var c = a(this),
                                d = getOptionsJson(c);
                            d.readonly ? d.buttonText = "只读": d.disabled && (d.buttonText = "禁止"),
                                c.iTextbox(d)
                        }),
                        a('[data-toggle="topjui-passwordbox"]').each(function(b) {
                            var c = a(this),
                                d = getOptionsJson(c);
                            c.iPasswordbox(d)
                        }),
                        a('[data-toggle="topjui-checkbox"]').each(function(b) {
                            var c = a(this),
                                d = getOptionsJson(c);
                            c.iCheckbox(d)
                        }),
                        a('[data-toggle="topjui-radio"]').each(function(b) {
                            var c = a(this),
                                d = getOptionsJson(c);
                            c.iRadio(d)
                        }),
                        a('[data-toggle="topjui-combo"]').each(function(b) {
                            var c = a(this),
                                d = getOptionsJson(c);
                            c.iCombo(d)
                        }),
                        a('[data-toggle="topjui-combobox"]').each(function(b) {
                            var c = a(this),
                                d = getOptionsJson(c);
                            c.iCombobox(d)
                        }),
                        a('[data-toggle="topjui-tagbox"]').each(function(b) {
                            var c = a(this),
                                d = getOptionsJson(c);
                            c.iTagbox(d)
                        }),
                        a('[data-toggle="topjui-numberbox"]').each(function(b) {
                            var c = a(this),
                                d = getOptionsJson(c);
                            c.iNumberbox(d)
                        }),
                        a('[data-toggle="topjui-datebox"]').each(function(b) {
                            var c = a(this),
                                d = getOptionsJson(c);
                            c.iDatebox(d)
                        }),
                        a('[data-toggle="topjui-datetimebox"]').each(function(b) {
                            var c = a(this),
                                d = getOptionsJson(c);
                            c.iDatetimebox(d)
                        }),
                        a('[data-toggle="topjui-datetimespinner"]').each(function(b) {
                            var c = a(this),
                                d = getOptionsJson(c);
                            c.iDatetimespinner(d)
                        }),
                        a('[data-toggle="topjui-calendar"]').each(function(b) {
                            var c = a(this),
                                d = getOptionsJson(c);
                            c.iCalendar(d)
                        }),
                        a('[data-toggle="topjui-spinner"]').each(function(b) {
                            var c = a(this),
                                d = getOptionsJson(c);
                            c.iSpinner(d)
                        }),
                        a('[data-toggle="topjui-numberspinner"]').each(function(b) {
                            var c = a(this),
                                d = getOptionsJson(c);
                            c.iNumberspinner(d)
                        }),
                        a('[data-toggle="topjui-timespinner"]').each(function(b) {
                            var c = a(this),
                                d = getOptionsJson(c);
                            c.iTimespinner(d)
                        }),
                        a('[data-toggle="topjui-slider"]').each(function(b) {
                            var c = a(this),
                                d = getOptionsJson(c);
                            c.iSlider(d)
                        }),
                        a('[data-toggle="topjui-filebox"]').each(function(b) {
                            var c = a(this),
                                d = getOptionsJson(c);
                            c.iFilebox(d)
                        }),
                        a('[data-toggle="topjui-textarea"]').each(function(b) {
                            var c = a(this),
                                d = getOptionsJson(c);
                            d.multiline = !0,
                        ...
                        a('[data-toggle="topjui-autocomplete"]').each(function(b) {
                            var c = a(this),
                                d = getOptionsJson(c);
                            c.iAutocomplete(d)
                        }),
                        a('[data-toggle="topjui-ueditor"]').each(function(b) {
                            var c = {
                                    height: 300
                                },
                                d = a(this),
                        ...
                        a('[data-toggle="topjui-upload-ue"]').each(function(b) {
                            var c = a(this),
                                d = getOptionsJson(c),
                                e = {
                                    width: 450,
                        ...
                        a('[data-toggle="topjui-upload-lay"]').each(function(b) {
                            var c = a(this),
                                d = getOptionsJson(c),
                                e = {
                                    width: 450,
                                ...
                                d = a.extend(e, d);
                            d = setId(c, d),
                            0 == a("#" + d.id + "-btn").length && (a("body").append('<button type="button" class="layui-btn" id="' + d.id + '-btn" style="display: none;">上传图片</button>'), layui.use("upload",
                                function() {
                                    var a = layui.jquery,
                                        b = layui.upload;
                                    b.render({
                        ...
                        a('[data-toggle="topjui-kindeditor"]').each(function(b) {
                            var c = a(this),
                                d = getOptionsJson(c);
                        ...
                        a('[data-toggle="topjui-upload"]').each(function(b) {
                            var c = a(this),
                                d = getOptionsJson(c);
                            setTimeout(function() {
                                    var b = d.url,
                ...
                a(document).on(topJUI.eventType.initUI.base,
                    function(b) {
                        a('[data-toggle="topjui-timeaxis"]').each(function(b) {
                            var c = a(this),
                                d = getOptionsJson(c);
                            c.iTimeaxis(d)
                        }),
                            a('[data-toggle="topjui-layout"]').each(function(b) {
                                var c = a(this),
                                    d = getOptionsJson(c);
                                c.iLayout(d)
                            }),
                            a('[data-toggle="topjui-accordion"]').each(function(b) {
                                var c = a(this),
                                    d = getOptionsJson(c);
                                c.iAccordion(d)
                            }),
                            a('[data-toggle="topjui-panel"]').each(function(b) {
                                var c = a(this),
                                    d = getOptionsJson(c);
                                c.iPanel(d)
                            }),
                            a('[data-toggle="topjui-treegrid"]').each(function(b) {
                                var c = a(this),
                                    d = getOptionsJson(c),
                                    e = [];
                            ...
                            a('[data-toggle="topjui-datagrid"]').each(function(b) {
                                var c = a(this),
                                    d = getOptionsJson(c),
                                    e = {
                                        initCreate: !0
                            ...
                            a('[data-toggle="topjui-edatagrid"]').each(function(b) {
                                var c = a(this),
                                    d = getOptionsJson(c),
                            ...
                            a('[data-toggle="topjui-tabs"]').each(function() {
                                var b = a(this),
                                    c = getOptionsJson(b);
                                b.attr("id", c.id),
                                    a("#" + c.id).iTabs(c)
                            }),
                            a('[data-toggle="topjui-menu"]').each(function() {
                                var b = a(this),
                                    c = getOptionsJson(b);
                            ...
                            a('[data-toggle="topjui-menubutton"]').each(function() {
                                var b = a(this),
                                    c = getOptionsJson(b);
                                c.id = getRandomNumByDef(),
                                    a(this).attr("id", c.id),
                            ...
                            a('[data-toggle="topjui-splitbutton"]').each(function() {
                                var b = a(this),
                                    c = getOptionsJson(b);
                                c.id = getRandomNumByDef(),
                                    a(this).attr("id", c.id),
                            ...
                            a('[data-toggle="topjui-uploader"]').each(function() {
                                var b = a(this),
                                    c = getOptionsJson(b);
                                c.hasDownArrow = !1,
                                    a(this).menubutton(c);
                                ...
                                b.on("click",
                                    function() {
                                        if ("object" == typeof c.parentGrid && (f = getSelectedRowData(c.parentGrid.type, c.parentGrid.id), !f)) return void a.messager.alert(topJUI.language.message.title.operationTips, c.parentGrid.unselectedMsg || topJUI.language.message.msg.selectParentGrid, topJUI.language.message.icon.warning);
                            ...
                            a('[data-toggle="topjui-submenubutton"]').each(function() {
                                var b = a(this),
                                    c = getOptionsJson(b);
                                bindMenuClickEvent(b, c),
                                    a(this).iSubMenubutton(c)
                            }),
                            a('[data-toggle="topjui-dialog"]').each(function() {
                                var b = a(this),
                                    c = getOptionsJson(b),
                                    d = b.attr("href");
                                void 0 != d && (c.href = d, a("body").append('<div id="' + c.id + '"></div>'), a("#" + c.id).iDialog(c), b.on("click",
                                    function() {
                                        return a("#" + c.id).dialog("open"),
                                            !1
                                    }))
                            }),
                            a('[data-toggle="topjui-linkbutton"]').each(function(b) {
                                var c = a(this),
                                    d = getOptionsJson(c);
                                c.iLinkbutton(d)
                            })
                    }),
                a(document).on(topJUI.eventType.initUI.base2,
                    function(b) {
                        a('[data-toggle="topjui-menu"]').each(function(b) {
                            var c = a(this),
                                d = getOptionsJson(c);
                            c.iMenu(d)
                        }),
                            a('[data-toggle="topjui-tree"]').each(function(b) {
                                var c = a(this),
                                    d = getOptionsJson(c);
                                c.iTree(d)
                            })
                    }),
                a(document).on(topJUI.eventType.initUI.echarts,
                    function(b) {
                        a('[data-toggle="topjui-echarts"]').each(function(b) {
                            var c = a(this),
                                d = getOptionsJson(c);
                            c.iEcharts(d)
                        })
                ...
                onClick: function(b) {
                    ...
                    if ("postCodeItemIdAndRefreshDatagrid" == c.clickEvent) {
                        ...
                        f.codeSetId = b.codesetid,
                            ...
                            f.pid = b.pid,
                            f.code = b.code,
                            d.datagrid("options").queryParams = a.extend({},
                                e, f),
                            d.datagrid("reload")
    ...
    function(a) {
        a.fn.iTreegrid = function(b, c) {
            ...
            a.fn.iTreegrid.parseOptions = function(b, c) {
                var d = a.extend({},
                    a.fn.treegrid.parseOptions(b), a.fn.iTreegrid.defaults, a.parser.parseOptions(b, ["id"]), c);
                return setId(b, d)
            },
            a.fn.iTreegrid.defaults = {
                ...
                onClickRow: function(b) {
                    ...
                    if ("object" == typeof c.childTabs) for (var j = c.childTabs,
                                                                 f = 0; f < j.length; f++) {
                        var k = a("#" + j[f].id),
                            l = k.tabs("options"),
